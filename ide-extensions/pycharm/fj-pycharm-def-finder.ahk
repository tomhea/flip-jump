; Double-click the script (with AutoHotKey v1 installed) to run now. Copy to "%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup" to still take effect after reboot.
