"""
The jump-target speculation miss-rate measurement (flipjump 1.5.0, WI-F study).
...
Usage:
    python tests/measure_speculation.py

The verdict lives in tests/benchmark_results.md (the "speculation study" section).
"""
...
from tests.benchmark_interpreter import get_benchmark_fjm  # noqa: E402
